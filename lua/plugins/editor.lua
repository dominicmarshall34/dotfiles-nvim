	...
	-- Which-key (v3 spec)
	{
		...
		config = function(_, opts)
			...
			wk.add({
				...
				{ "<leader>d", desc = "Line diagnostics (float)", mode = "n" },
				{ "<leader>D", desc = "Buffer diagnostics (Telescope)", mode = "n" },
			})
